  ...
  return (
    <div>
        ...
        sx={{bgcolor:"black", color:"white", py:3}}>
            ...
            <Grid item xs={12} sm={6} md={3}>
                <Typography className='pb-5' variant='h6'> Sloutions </Typography>
                <div>
        ...
        <Grid bgcolor={'black'} text color={'white'}>
            <Grid>
                <Typography className='text-center' variant='h6' > © 2024 MyCompany, Inc. All rights reserved. </Typography>
            </Grid>
        </Grid>
